...
- Registry version: `0.100.0`
- Registry SHA-256: `2914089F11DA14162F1A9110A0DD502AE2AF99AED5974AEFEBDA33B8C5E126E5`
...
- Operational support: `parse`=verified, `semantic`=implemented, `inspect`=verified, `modify`=unsupported, `create`=unsupported, `delete`=unsupported, `rename`=unsupported, `generate`=unsupported, `static_validation`=implemented, `execute`=unassessed
...
- Coverage: documented
- Evidence: [evidence.fe-command-dispatch](#evidencefe-command-dispatch), [evidence.fe-core-records](#evidencefe-core-records)
- Operational support: `parse`=verified, `semantic`=verified, `inspect`=verified, `modify`=verified, `create`=verified, `delete`=verified, `rename`=verified, `generate`=unsupported, `static_validation`=verified, `execute`=unassessed
...
- Coverage: documented
- Evidence: [evidence.fe-command-dispatch](#evidencefe-command-dispatch), [evidence.current-vtms-deck-notch](#evidencecurrent-vtms-deck-notch), [evidence.runtime-generated-isotropic-solid-success](#evidenceruntime-generated-isotropic-solid-success)
- Operational support: `parse`=verified, `semantic`=verified, `inspect`=verified, `modify`=unsupported, `create`=unsupported, `delete`=unsupported, `rename`=unsupported, `generate`=verified, `static_validation`=verified, `execute`=verified
...
Termination: next-command. Dependencies: Referenced clusters must be selected by the boundary problem.; All node sets and declaration-order material, constitutive, and failure IDs must already exist.; Ply or mesh changes must revalidate both sides of every connection.
