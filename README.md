...
The extension does not send model data to a hosted provider. Hosted providers remain optional and deferred. Registry-derived parameter forms, reviewed diffs, and confirmation-gated apply/run/stop controls are available; integrated local chat remains the active M6 work.
